...
const AUTH_ELO_RANKS = {
  beginner:     { min: 0,    max: 1200, name: 'Beginner',     class: 'rank-beginner' },
  intermediate: { min: 1201, max: 2000, name: 'Intermediate', class: 'rank-intermediate' },
  advanced:     { min: 2001, max: 9999, name: 'Advanced',     class: 'rank-advanced' }
};
